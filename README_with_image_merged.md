...
![保存率改善アクションマップ](save_rate_improvement_map_illustration.png)

**図の解説**  
このマップは、曜日・時間帯・投稿形式ごとの保存率への影響を可視化したものです。  
色分けで重要度を分類しており、優先的に取り組むべき施策が一目で分かります。

**改善ポイント（サマリ）**  
- **月・火** に重要投稿を集中させる  
- **カルーセル形式**を増やし、情報を段階的に提示  
- **18〜21時**の投稿を中心に時間帯を最適化  
- **保存促進要素**（チェックリストやHowTo）を盛り込む  
- 水曜・日曜は実験枠として活用
